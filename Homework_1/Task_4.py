...
if revenue > costs:
    ...
    print(f"Ваша фирма работает с прибылью: {profit}. Рентабельность выручки {profitability}")
    employees_sum = int(input("Введите численность сотрудников фирмы: "))
    profit_employee = profit / employees_sum
    print(f"Прибыль фирмы в расчёте на одного сотрудника: {int(profit_employee)}.")
else:
